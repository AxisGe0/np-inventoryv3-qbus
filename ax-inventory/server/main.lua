...
AddEventHandler('inventory:server:GiveItem', function(name, inventory, item, amount)
	...
	if amount ~= 0 then
		if Player.Functions.RemoveItem(item.name, amount, item.slot) and OtherPlayer.Functions.AddItem(item.name, amount,false, item.info) then
	...
	elseif QBCore.Shared.SplitStr(fromInventory, "-")[1] == "stash" then
		...
		if fromItemData ~= nil and fromItemData.amount >= fromAmount then
			...
			if toInventory == "player" or toInventory == "hotbar" then
				...
				RemoveFromStash(stashId, fromSlot, itemInfo["name"], fromAmount)
				--Player.PlayerData.items[toSlot] = fromItemData
				if toItemData ~= nil then--[[MADE BY Ax is bro ther made by axis brother dream life roleplay ax is brother Axis#1672
					fuck Indian Empire RolePlay Fuk You All Halka gorib you too!]]--[[MADE BY Ax is bro ther made by axis brother dream life roleplay ax is brother Axis#1672
fuck Indian Empire RolePlay Fuk You All Halka gorib you too!]]--[[MADE BY Ax is bro ther made by axis brother dream life roleplay ax is brother Axis#1672
fuck Indian Empire RolePlay Fuk You All Halka gorib you too!]]--[[MADE BY Ax is bro ther made by axis brother dream life roleplay ax is brother Axis#1672
fuck Indian Empire RolePlay Fuk You All Halka gorib you too!]]--[[MADE BY Ax is bro ther made by axis brother dream life roleplay ax is brother Axis#1672
